...
- Optionally use your Redis server for the limiter / bot protection (via a Home Assistant Redis service or the `redis_host` / `redis_port` / `redis_password` options); Redis is not required
